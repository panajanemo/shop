...
public class CodeGenerator {
    ...
    public static void main(String[] args) {
        ...
        globalConfig.setOutputDir("E:\\ideaProject\\shop_parent\\shop_core\\shop_product\\src\\main\\java");
        globalConfig.setAuthor("panajanemo");
        //生成后是否打开资源管理器
        ...
        dataSourceConfig.setUrl("jdbc:mysql://192.168.17.128:3306/shop_product?useSSL=false&serverTimezone=Asia/Shanghai&characterEncoding=utf-8&autoReconnect=true");
